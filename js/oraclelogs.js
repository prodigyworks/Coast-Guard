...
function formatDate(d) {
	...
	return  (padZero(curr_date) + "/" + padZero(curr_month) + "/" + curr_year);
}

function formatTime(d) {
	var curr_date = d.getHours();
	var curr_month = d.getMinutes(); //Months are zero based
	
	return  (padZero(curr_date) + ":" + padZero(curr_month));
}
...
function formatDateTime(d) {
	...
	var curr_min = d.getMinutes(); //Months are zero based
	var curr_sec = d.getSeconds();
	
	return (curr_year + "-" + padZero(curr_month) + "-" + curr_date) + " " + (padZero(curr_hour) + ":" + padZero(curr_min) + ":" + padZero(curr_sec));
}
